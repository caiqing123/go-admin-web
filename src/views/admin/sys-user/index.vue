        ...
        <el-row :gutter="20">
          ...
          <el-col :span="20" :xs="24">
            ...
            >
              ...
              <el-table-column label="编号" width="75" prop="id" sortable="custom" />
              <el-table-column label="登录名" width="105" prop="name" :show-overflow-tooltip="true" />
              <el-table-column label="昵称" prop="nick_name" :show-overflow-tooltip="true" />
              <el-table-column label="手机号" prop="phone" width="108" />
              <el-table-column label="角色" prop="role_name" width="108" />
...
export default {
    ...
    return {
      ...
      rules: {
        ...
        phone: [
          ...
          { pattern: /^1[3|456789]\d\d{8}$/, message: '请输入正确的手机号码', trigger: 'blur' }
        ]
      }
    }
  },
  ...
  methods: {
    ...
    handleAdd() {
      ...
      listRole({ per_page: 100 }).then(response => {
    ...
    handleUpdate(row) {
      ...
      getUser(id).then(response => {
        ...
        this.open = true
        this.title = '修改用户'
        this.form.role_id = parseInt(this.form.role_id)
        this.form.password = ''
      })
      listRole({ per_page: 100 }).then(response => {
        this.roleOptions = response.data
