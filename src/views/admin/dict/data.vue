    ...
    <template #wrapper>
      <el-card class="box-card">
        ...
        <el-table v-loading="loading" :data="dataList" border @selection-change="handleSelectionChange">
          ...
          <el-table-column label="字典编码" width="80" align="center" prop="dict_code" />
        ...
        <el-dialog :title="title" :visible.sync="open" width="80%">
          <el-form ref="form" :model="form" :rules="rules" label-width="80px">
            ...
            <el-form-item label="数据标签" prop="dict_label">
              <el-input v-model="form.dict_label" placeholder="请输入数据标签" :disabled="isEdit" />
            </el-form-item>
            <el-form-item label="数据键值" prop="dict_value">
              <el-input v-model="form.dict_value" placeholder="请输入数据键值" :disabled="isEdit" />
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    /** 查询字典类型列表 */
    getTypeList() {
      listType({ per_page: 100 }).then(response => {
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      const dictCodes = (row.dict_code && [row.dict_code]) || this.ids
