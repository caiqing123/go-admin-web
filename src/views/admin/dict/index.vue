      ...
      <el-card class="box-card">
        ...
        <el-dialog :title="title" :visible.sync="open" width="80%">
          <el-form ref="form" :model="form" :rules="rules" label-width="80px">
            <el-form-item label="字典名称" prop="dict_name">
              <el-input v-model="form.dict_name" placeholder="请输入字典名称" :disabled="isEdit" />
            </el-form-item>
            <el-form-item label="字典类型" prop="dict_type">
              <el-input v-model="form.dict_type" placeholder="请输入字典类型" :disabled="isEdit" />
            </el-form-item>
            <el-form-item label="状态" prop="status">
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有类型数据项?', '警告', {
        ...
        import('@/vendor/Export2Excel').then(excel => {
          ...
          const filterVal = ['id', 'dict_name', 'dict_type', 'status', 'remark']
