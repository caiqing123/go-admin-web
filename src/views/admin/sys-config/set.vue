            ...
            <el-form label-width="80px">
              <div class="test-form">
                <el-form ref="form" :model="form" :rules="rules" size="small" label-width="100px">
                  ...
                  <el-form-item label="皮肤样式" prop="theme">
                    <el-select v-model="form.theme" placeholder="请选择皮肤样式" clearable :style="{width: '100%'}">
                  ...
                  <el-form-item label="侧栏主题" prop="themeStyle">
                    <el-select v-model="form.themeStyle" placeholder="请选择侧栏主题" clearable :style="{width: '100%'}">
